...
async def task(interaction: discord.Interaction, add:str):
        await interaction.response.send_message("You have successfully added" + add)
...
#test command
@tree.command(name="test", description="testing", guild=discord.Object(id=868279391074021377))
